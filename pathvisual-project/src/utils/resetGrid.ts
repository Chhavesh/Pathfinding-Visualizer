import { END_TITLE_CONFIGURATION, MAX_COLS, MAX_ROWS, START_TITLE_CONFIGURATION, TILE_STYLE } from "./constants";
import { isEqual } from "./helpers";
import { GridType, TileType } from "./types";

export const resetGrid = ({
    grid,
    startTile = START_TITLE_CONFIGURATION,
    endTile = END_TITLE_CONFIGURATION,
}: {
    grid: GridType,
    startTile?: TileType,
    endTile?: TileType,
